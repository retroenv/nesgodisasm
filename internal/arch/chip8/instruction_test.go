...
// Benchmark instruction operations
func BenchmarkInstruction_IsCall(b *testing.B) {
	instr := Instruction{ins: chip8.Call}
...
func BenchmarkInstruction_Name(b *testing.B) {
	instr := Instruction{ins: chip8.Jp}
...
func BenchmarkInstruction_IsNil(b *testing.B) {
	instr := Instruction{ins: chip8.Jp}
